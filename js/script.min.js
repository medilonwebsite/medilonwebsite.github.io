...
jQuery(function($){new WOW().init();});jQuery(document).ready(function(){$('body').scrollspy({target:'.navbar-collapse',offset:195});$(window).on('scroll',function(){if($(window).scrollTop()>200){$('.fixed-top').addClass('menu-bg');}else{$('.fixed-top').removeClass('menu-bg');}});});$(window).on("scroll",function(){if($(window).scrollTop()>100){$('#atc01 ul').addClass("active");}else{$('#atc01 ul').removeClass("active");}
